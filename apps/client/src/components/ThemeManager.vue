      ...
      >
        ...
        <div class="flex-shrink-0 bg-[var(--theme-bg-primary)] border-b border-[var(--theme-border-primary)] p-6">
          <div class="flex items-center justify-between mb-4">
            ...
            <button
              @click="close"
              class="p-2 hover:bg-[var(--theme-bg-tertiary)] rounded-lg transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center"
            >
        ...
        <div class="flex-1 p-6 overflow-y-auto">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            ...
            >
              ...
              <p class="text-sm text-[var(--theme-text-secondary)] mt-1">{{ theme.description }}</p>
              
              <!-- Current indicator -->
              <div v-if="currentTheme === theme.name" class="mt-2">
                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100/20 text-green-500">
          ...
          <div class="flex justify-between items-center pt-4 border-t border-[var(--theme-border-primary)]">
            ...
            <button
              @click="close"
              class="px-4 py-2 bg-[var(--theme-bg-tertiary)] text-[var(--theme-text-primary)] rounded-lg hover:bg-[var(--theme-bg-quaternary)] transition-colors"
            >
              Close
            </button>
          </div>
